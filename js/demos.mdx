...
It is typically delivered as an embed on your marketing site, or as part of a Chameleon [Tour](/api/tours).
...
engagement with Product Demos into the other experiences that Chameleon offers such as [Tours](/api/tours)),
[Microsurveys](/api/surveys), and [HelpBar](/api/helpbar). 
