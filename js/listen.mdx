---
title: "Listen to Chameleon events"
---
...
<Note>Typical ordering as Chameleon boots: `load`, `load:chmln`, `after:account`, `identify:request`, `identify:sync`, `after:profile`, `tour:event`, `chmln:event`</Note>
...
<Note>You can easily adapt this based on where you'd like to send this data in your system.</Note>