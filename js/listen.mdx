...
- Knowing when the [HelpBar](/api/search#search-javascript-api) is opened/closed or when data is needed.
...
The [JavaScript API for HelpBar](/api/search#search-javascript-api) has many examples and use cases.
