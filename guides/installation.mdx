...
Imagine that you want to send your Users to the billing page. With this script you can setup a Navigate type of HelpBar [SearchItem](/api/helpbar#searchitem-schema) for the Billing page and link to `/settings/billing`.
