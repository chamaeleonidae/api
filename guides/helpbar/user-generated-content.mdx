...
In this guide we will talk about how to make your User-generated content ([SearchItem](apis/search#schema-search-items)s) searchable with the HelpBar. This guide makes some assumptions
...
## Sample Data in the Dashy database {#example-data}
...
## Lifecycle of content (CRUD) {#lifecycle-crud}
...
### Create: Add this content to HelpBar {#examples-crud-create-basic}
...
### Update: Conditionally update with important changes {#examples-crud-update-basic}
...
### Delete: Remove content from HelpBar {#examples-crud-delete-basic}
