...
**Data in Chameleon is [normalized](concepts/normalization) for storage, to eliminate redundancy and data inconsistency and to ensure proper querying and analysis.**
