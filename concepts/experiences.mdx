Chameleon **_Experience_** is the generic name for any of [Tour](/api/tours), [Microsurvey](/api/surveys), [Launcher](/api/launchers), or [Tooltip](/api/tooltips).
...
When [Tags](/api/tags) or [Environments](/api/urls) are added to an experience, it will look like this:
