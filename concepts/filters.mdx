---
title: "Segmentation Filter Expressions"
---
...
<ResponseField name="kind" type="string">
  The type of Segmentation filter item: One of `property`, `event`, `tour`, `action`, `intercom`, or `segment`
</ResponseField>

<ResponseField name="integration" type="string">
  The data partner if any
</ResponseField>

<ResponseField name="prop" type="string">
  The specific property that forms the left hand side of an expression
</ResponseField>

<ResponseField name="op" type="string">
  The specific operation to be performed. Can be compounded with a value translation
</ResponseField>

<ResponseField name="value" type="string">
  The specific Value that forms the right hand side of an expression
</ResponseField>

<ResponseField name="mod" type="string">
  A secondary condition is modified with this Operator
</ResponseField>

<ResponseField name="range" type="string">
  A secondary condition is compared with this Value
</ResponseField>

<ResponseField name="cond" type="string">
  A Secondary condition Operator used 1-to1 with `int` to form a time-range limitation on the main match
</ResponseField>

<ResponseField name="int" type="string">
  Used 1-to-1 with `cond` to specify an interval
</ResponseField>
...
Other examples can be found on the [searching profiles](/apis/profiles-search#examples) page.
