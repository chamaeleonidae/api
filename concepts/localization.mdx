...
<Warning>Localization is in BETA at the moment ([Contact us](https://app.chameleon.io/help) to join) and available as an add-on to our Growth / Enterprise plans.</Warning>

<Tip>The main [Help page](https://help.chameleon.io/en/articles/5868890) on this topic may be more helpful for a typical workflow.</Tip>

1. [Download](/api/translation#download-translation-files) or from the [various lists of Experiences](https://app.chameleon.io).
2. Translate
3. [Upload](/api/translation#upload-translation-files) or from the [Localization page](https://app.chameleon.io/settings/translations).
...
| `experiences`        | array&lt;Object&gt; | optional | Each member of this array has two keys `kind` and `id` [examples](/api/translations#example-download-experiences) |
