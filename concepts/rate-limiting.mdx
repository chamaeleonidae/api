...
- [Creating a Delivery](apis/deliveries) with `max_concurrent=1` per User Profile to handle the enforcement of the maximum [Pending Deliveries](/api/deliveries#limits).
