...
| `delivery`                 | [examples ↓](/concepts/personalizing.md?id=examples-delivery)   | Personalize with content explicitly sent via a [Delivery](/api/deliveries)         |
| `html`                     | [examples ↓](/concepts/personalizing.md?id=examples-html)       | Output html based on given options                                                    |
| `filter`                   | [examples ↓](/concepts/personalizing.md?id=examples-filter)     | Use filter to evaluate [Segmentation filter expressions](/concepts/filters)         |                                  |
