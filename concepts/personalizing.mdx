...
|----------------------------|----------------------------------------------------------------|---------------------------------------------------------------------------------------|
| `property`                 | [examples ↓](/concepts/personalizing#examples-property)   | The default used when a unquoted string is found at the beginning                     |
| `global`                   | [examples ↓](/concepts/personalizing#examples-global)     | Pull a value from the window object, useful for extra-advanced conditional formatting |
| `pluralize`                | [examples ↓](/concepts/personalizing#examples-plural)     | Given a specific number and a word produces a phrase with the correct tense           |
| `time_difference_in_words` | [examples ↓](/concepts/personalizing#examples-time-diff)  | Given a specific date/time produces a time offset                                     |
| `time_ago`                 | [examples ↓](/concepts/personalizing#examples-time-ago)   | Calculates the offset from now in `seconds`,`minutes`,`hours`,`days`,`weeks`,`years`  |
| `time_local`               | [examples ↓](/concepts/personalizing#examples-time-local) | Given a specific date/time uses toLocalString() to generate a human readable string   |
| `delivery`                 | [examples ↓](/concepts/personalizing#examples-delivery)   | Personalize with content explicitly sent via a [Delivery](/apis/deliveries)         |
| `html`                     | [examples ↓](/concepts/personalizing#examples-html)       | Output html based on given options                                                    |
| `filter`                   | [examples ↓](/concepts/personalizing#examples-filter)     | Use filter to evaluate [Segmentation filter expressions](/concepts/filters)         |                                  |
| `if` (content logic)       | [examples ↓](/concepts/personalizing#examples-logic-if)   | Output html based on given options                                                    |
...
### Greeting with a User's name | `property` helper {#examples-property}
...
### Use a relative offset time | `time_difference_in_words` helper {#examples-time-diff}
...
### Calculate differences between dates | `time_ago` helper {#examples-time-ago}

This calculation is best used as a nested helper in an `if` block | [examples ↓](/concepts/personalizing#examples-logic-if)
...
**As part of an `if` block** | [more examples ↓](/concepts/personalizing#examples-logic-if)
...
### Display a timestamp/date in a presentable format | `time_local` helper {#examples-time-local}
...
### Pluralizing numbers | `pluralize` helper {#examples-plural}
...
## Examples using `delivery` helper {#examples-delivery}
...
### Show a custom link | `html` helper {#examples-html}
...
### Use custom logic | `if` block helper {#examples-logic-if}
...
## Segmentation filter conditions | `filter` helper {#examples-filter}
