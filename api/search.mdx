...
See the specific APIs for more information on how to use Search your product.
 ...
 - [REST API](/api/search#helpbar-rest-api)
 - [JavaScript API](/api/search#search-javascript-api)
 - [Limits](/api/search#limits)


#### To get HelpBar up and running, complete these items:

1. Create a [HelpBar](/api/search#search-bar-schema), configure it with `placeholder` etc.
2. Add your Help center as a [`SearchGroup`](/api/search#searchgroups-schema).
3. Add the top-level navigation within your product; First download this CSV [template](/api/search#search-imports-template) or [example](/api/search#search-imports-example) then [Import](/api/search#schema-search-imports) it.
4. [Optional] Add specific content from your database by creating a [SearchItem](/api/search#schema-search-items) per database record you want to be searchable.
...
> `Search` is associated with `groups`: [SearchGroups](/api/search#schema-search-groups), and `label_themes`: [SearchLabelThemes](/api/search#schema-search-groups)
...
| `oids`                        | none      | A set of pre-known IDs to directly add [SearchItem](/api/search#schema-search-items)s to the default [SearchGroup](/api/search#schema-search-groups)s |
...
| `created_at`                | timestamp | When this happened or when this was added to the Database                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `updated_at`                | timestamp | The last time any property was updated                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `url`                       | string    | The URL that this [SearchGroup](/api/search#schema-search-groups) uses to fetch Search content                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `icon`                      | object    | The `SearchIcon` info to display for all results of this [SearchGroup](/api/search#schema-search-groups)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `icon.image_url`            | none      | When using `kind="image"`, the url to an appropriate icon for this [SearchGroup](/api/search#schema-search-groups)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `icon.image_alt`            | none      | When using `kind="image"`, the alt text for the icon                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `url_options`               | object    | When configuring this [SearchGroup](/api/search#schema-search-groups) for an Search integration, Chameleon will fetch some information about the given URL                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
There is only one per account so an update uses the same endpoint as create. Use any of the properties available in the [schema](/api/search#schema)
...
> `SearchItem`s are associated with `actions`: [SearchActions](/api/search#schema-search-actions), and `title_labels` / `description_labels`: [SearchLabels](/api/search#schema-search-labels)
...
| `search_group_id`    | string    | The [SearchGroup](/api/search#schema-search-groups) that this `SearchItem` will display in.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `icon.image_url`     | sting     | When using `kind="image"`, the url to an appropriate icon for this [SearchGroup](/api/search#schema-search-groups)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `icon.image_alt`     | string    | When using `kind="image"`, the alt text for the icon                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `actions`            | array     | An array of the [`SearchAction`](/api/search#schema-search-actions) that run when this `SearchItem` is clicked/selected in the HelpBar                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `title_labels`       | array     | An array of the [`SearchLabel`](/api/search#schema-search-labels) items displayed in the title of this `SearchItem`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `description_labels` | array     | An array of the [`SearchLabel`](/api/search#schema-search-labels) items displayed under the description of this `SearchItem`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `search_import_id` | optional | Fetch only the `SearchItem`s that were created (or updated most recently) by the given [SearchImport](/api/search#schema-search-imports). |
...
Use any of the properties available in the [schema](/api/search#schema-search-items).
...
It also includes a title label of `NEW` themed with an [example theme](/api/search#searches-create-http-response) from above.
...
| `*others` | optional | Use any of the properties available in the [single SearchItem update](/api/search#search-items-create) |
...
To update the [SearchGroup](/api/search#schema-search-group) of many items:
...
A search action is one item in a collection of actions attached to a [SearchItem](/api/search#schema-search-items)s. When
...
See the [Type definitions below ↓](/api/search#search-js-types)
