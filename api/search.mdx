...
> **You have content within your product, even if you don't think of it that way. Any database records that your Users would want to find is a piece of content, akin to a Google search result. Send this content to Chameleon and we will surface it to your Users in the Chameleon HelpBar. The content can be scoped to a specific [Company](/api/company), be pinned to the top when the HelpBar is opened and can perform any action from clicking an item.**.

------

See the specific APIs for more information on how to use Search your product.

 - [REST API](/api/search.md?id=search-rest-api)
 - [JavaScript API](/api/search.md?id=search-js-api)
 - [Limits](/api/search.md?id=limits)


#### To get HelpBar up and running, complete these items:

1. Create a [HelpBar](/api/search.md?id=schema), configure it with `placeholder` etc.
2. Add your Help center as a [`SearchGroup`](/api/search.md?id=schema-search-groups).
3. Add the top-level navigation within your product; First download this CSV [template](/api/search.md?id=search-imports-template) or [example](/api/search.md?id=search-imports-example) then [Import](/api/search.md?id=schema-search-imports) it.
4. [Optional] Add specific content from your database by creating a [SearchItem](/api/search.md?id=schema-search-items) per database record you want to be searchable.
...
- Index custom content (the data from your product) into searchable [SearchItem](/api/search.md?id=schema-search-items)s.
- Import your product navigation to allow your Users to jump to a specific thing they are looking for with a [SearchImport](/api/search.md?id=schema-search-imports).
- Configure [SearchGroups](/api/search.md?id=schema-search-groups) to pull content from public sources (i.e. your Help center, Blog etc.).
- Define a [SearchLabelTheme](/api/search.md?id=schema-search-label-themes) to label your [SearchItem](/api/search.md?id=schema-search-items)s for greater visibility.
- Add labels to the title or description of `SearchItem`s as [SearchLabel](/api/search.md?id=schema-search-labels)s.


## `Search` bar Schema

> `Search` is associated with `groups`: [SearchGroups](/api/search.md?id=schema-search-groups), and `label_themes`: [SearchLabelThemes](/api/search.md?id=schema-search-groups)
...
| `url_group_ids`               | array     | The [`Environment`](/api/urls.md?id=url-groups) that this is enabled to run on                                                                                    |
...
| `oids`                        | none      | A set of pre-known IDs to directly add [SearchItem](/api/search.md?id=schema-search-items)s to the default [SearchGroup](/api/search.md?id=schema-search-groups)s |
...
| `created_at`                | timestamp | When this happened or when this was added to the Database                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `updated_at`                | timestamp | The last time any property was updated                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `url`                       | string    | The URL that this [SearchGroup](/api/search.md?id=schema-search-groups) uses to fetch Search content                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `icon`                      | object    | The `SearchIcon` info to display for all results of this [SearchGroup](/api/search.md?id=schema-search-groups)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `icon.image_url`            | none      | When using `kind="image"`, the url to an appropriate icon for this [SearchGroup](/api/search.md?id=schema-search-groups)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `icon.image_alt`            | none      | When using `kind="image"`, the alt text for the icon                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `url_options`               | object    | When configuring this [SearchGroup](/api/search.md?id=schema-search-groups) for an Search integration, Chameleon will fetch some information about the given URL                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
There is only one per account so an update uses the same endpoint as create. Use any of the properties available in the [schema](/api/search.md?id=schema)
...
> `SearchItem`s are associated with `actions`: [SearchActions](/api/search.md?id=schema-search-actions), and `title_labels` / `description_labels`: [SearchLabels](/api/search.md?id=schema-search-labels)
...
| `search_group_id`    | string    | The [SearchGroup](/api/search.md?id=schema-search-groups) that this `SearchItem` will display in.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `profile_ids`        | array     | The IDs of the [User Profile](/api/profiles) that has access to this `SearchItem`. Only members these specific [User Profiles](/api/profiles) will be displayed this `SearchItem` as a search result                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `company_ids`        | array     | The IDs of the [Company](/api/companies) that has access to this `SearchItem`. Only members of this [Company](/api/companies) will be displayed this `SearchItem` as a search result                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `segment_ids`        | array     | The IDs of the [Segment](/api/segments) that has access to this `SearchItem`. Only current members of this [Segment](/api/segment) will be displayed this `SearchItem` as a search result                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `company_uids`       | array     | The external ID (from in your database) for which Company has access to this `SearchItem`. Only members of this [Company](/api/companies) will be displayed this `SearchItem` as a search result                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `profile_uids`       | array     | The external ID of the [User Profile](/api/profiles) that has access to this `SearchItem`. Only members these specific [User Profiles](/api/profiles) will be displayed this `SearchItem` as a search result                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `icon.image_url`     | sting     | When using `kind="image"`, the url to an appropriate icon for this [SearchGroup](/api/search.md?id=schema-search-groups)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `icon.image_alt`     | string    | When using `kind="image"`, the alt text for the icon                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `actions`            | array     | An array of the [`SearchAction`](/api/search.md?id=schema-search-actions) that run when this `SearchItem` is clicked/selected in the HelpBar                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `title_labels`       | array     | An array of the [`SearchLabel`](/api/search.md?id=schema-search-labels) items displayed in the title of this `SearchItem`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `description_labels` | array     | An array of the [`SearchLabel`](/api/search.md?id=schema-search-labels) items displayed under the description of this `SearchItem`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `search_import_id` | optional | Fetch only the `SearchItem`s that were created (or updated most recently) by the given [SearchImport](/api/search.md?id=schema-search-imports). |
...
Use any of the properties available in the [schema](/api/search.md?id=schema-search-items).
...
Target content to a Chameleon [Segment](/api/segments) of Users
...
Target content to three Chameleon [Companies](/api/companies) -- Only members of these companies will be able to search for this item.

As parameters you can send either `company_uids` as the ID from **your database** or you can first lookup the
Chameleon [Companies](/api/companies.md?id=companies-show) and then send `company_ids` parameter.
...
Target content to a Chameleon [Company](/api/companies) -- Only members of this Company will be able to search for this item.
...
Target content to a Chameleon [User Profile](/api/profiles) -- Only this specific User will be able to search for this item.
...
It also includes a title label of `NEW` themed with an [example theme](/api/search.md?id=searches-create-http-response) from above.
...
| `*others` | optional | Use any of the properties available in the [single SearchItem update](/api/search.md?id=search-items-create) |
...
To update the [SearchGroup](/api/search.md?id=schema-search-group) of many items:
...
A search action is one item in a collection of actions attached to a [SearchItem](/api/search.md?id=schema-search-items)s. When
...
See the [Type definitions below ↓](/api/search.md?id=search-js-types)
...
| `search_group_id`           | string    | The [SearchGroup](/api/search.md?id=schema-search-groups) that all of the resulting `SearchItem`s will display in.  (and/or this can be customized per row with "HelpBar Group ID" column) |
...
| `stats`                     | object    | The details of the data itself and of the last run of this [SearchImport](/api/search.md?id=schema-search-imports).                                                      |
