...
See the specific APIs for more information on how to use Search your product.
 ...
 - [REST API](/api/search#search-rest-api)
 - [JavaScript API](/api/search#search-js-api)
 - [Limits](/api/search#limits)


#### To get HelpBar up and running, complete these items:

1. Create a [HelpBar](/api/search#schema), configure it with `placeholder` etc.
2. Add your Help center as a [`SearchGroup`](/api/search#schema-search-groups).
