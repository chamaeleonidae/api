...
| `segment_id` | ID | The Chameleon ID of the configured [Segment](/api/segments.md?id=schema) |
...
See [Listing Related models](/api/segments.md?id=segment-experiences-index)
