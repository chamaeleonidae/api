...
- Used to define [Rate Limit Groups](/api/limit-groups) of Experiences that are limited to a particular rate limit (i.e. 2 per week, 3 per month etc.).
...
| `models_count` | number | The number of [Experiences](/api/overview) attached to this Tag |
