...
<CardGroup cols={2}>
  <Card title="List Tours" icon="list" href="#list-tours">
    Get all tours with filtering and pagination
  </Card>
  <Card title="Retrieve Tour" icon="eye" href="#retrieve-a-tour">
    Get a specific tour by ID
  </Card>
  <Card title="Update Tour" icon="pen" href="#update-a-tour">
    Modify existing tour properties and settings
  </Card>
  <Card title="Filter by Segment" icon="filter" href="#filtering-by-segment">
    Find tours targeted to specific user segments
  </Card>
</CardGroup>
...
Update a single Tour to change the [Environments](/api/urls) or to Publish it.
