...
| `changes`    | array&lt;ChangeUpdate&gt;  | An Array of [ChangeUpdate](api/changes.md?id=schema-summary-change-update-item) items representing changes to child associated models ([Steps](/api/steps), [Buttons](/api/buttons) etc.                         |
