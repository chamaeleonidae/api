...
#### Fully-expanded [Company](/api/companies) when listed directly or embedded with `expand` param specified properly
...
#### Non-expanded [Company](/api/companies) when embedded in another (i.e. Microsurvey response)
