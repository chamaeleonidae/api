...
<CardGroup cols={2}>
  <Card title="Create / Update Company" icon="building" href="#create--update-a-company">
    Create new companies or update existing company properties
  </Card>
  <Card title="Retrieve Company" icon="eye" href="#retrieve-a-company">
    Get a specific company by ID or UID
  </Card>
  <Card title="List Companies" icon="list" href="#list-companies">
    Get all companies with filtering and pagination
  </Card>
  <Card title="Delete Company" icon="trash" href="#delete-a-company">
    Permanently remove a company and its data
  </Card>
</CardGroup>
...
| param.  | -        | description                                                          |
| ------- | -------- | -------------------------------------------------------------------- |
| `id`    | optional | The Chameleon ID of the [Company](/api/companies)                 |
| `uid`   | optional | The Company identifier (typically the Database ID from your backend) |
