...
**[Jump to Environments](/api/urls#url-groups)**
...
- Enable new domains [jump ↓](/api/urls#urls-create).
- Assign domains to different Environments [jump ↓](/api/urls#url-groups-create) (production,staging,test,etc.).
...
| `url_group_id`  | ID        | The Environment ([Url Group](/api/urls#url-groups)) this Url is a part of. `null` to be part of all Environments.                         |
...
| `unlisted`     | optional | [deprecated; replaced by `archived_at`] Whether or not the Url is displayed on the [Domains page](https://app.chameleon.io/settings/domains) in the dashboard |
| `archived_at`  | optional | To archive set to a timestamp, to unarchive set to `null`                                                                                                         |
| `url_group_id` | optional | The Environment ([Url Group](/api/urls#url-groups)) to assign this Url to                                                                                                                 |
...
| `archived_at`  | optional | To archive set to a timestamp, to unarchive set to `null`                         |
| `url_group_id` | optional | The Environment ([Url Group](/api/urls#url-groups)) to assign these Urls to |
...
[Updating a Url](/api/urls#urls-update) with a `url_group_id` of an Environment ([Url Group](/api/urls#url-groups)) will assign it to that Environment


## Removing Domains from an Environment

[Updating a Url](/api/urls#urls-update) with a `url_group_id` equal to `null` will assign it to the Default Environment
...
| param  | -        | description                                                                            |
|--------| -------- |----------------------------------------------------------------------------------------|
| `id`   | required | The Chameleon ID of the Environment ([Url Group](/api/urls#url-groups)) to show  |
