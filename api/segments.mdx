...
<CardGroup cols={3}>
  <Card title="List Segments" icon="list" href="#listing-segments">
    Retrieve segments with filtering and pagination
  </Card>
  <Card title="Get Segment" icon="eye" href="#showing-a-segment">
    Retrieve a specific segment by ID
  </Card>
  <Card title="List Related Experiences" icon="chain" href="#listing-related-experiences">
    Get all experiences connected to a segment
  </Card>
</CardGroup>
...
A Segment can be configured to be attached to many Chameleon Experiences, including [Microsurveys](/api/surveys), [Tours](/api/tours) and [Launchers](/api/launchers) and [Rate Limit Groups](/api/limit-groups). This endpoint allows you to list any of these items that are currently attached to the Segment given with the ID
