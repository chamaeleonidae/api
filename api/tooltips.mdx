...
<CardGroup cols={3}>
  <Card title="List Tooltips" icon="list" href="#list-tooltips">
    Get all tooltips with filtering parameters
  </Card>
  <Card title="Retrieve Tooltip" icon="eye" href="#retrieve-a-tooltip">
    Get a specific tooltip by ID
  </Card>
  <Card title="Update Tooltip" icon="pen" href="#update-a-tooltip">
