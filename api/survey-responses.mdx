...
<CardGroup cols={2}>
  <Card title="List Responses" icon="list" href="#list-microsurvey-responses">
    Get all microsurvey responses with filtering
  </Card>
  <Card title="Delete Response" icon="trash" href="#delete-a-microsurvey-response">
    Remove a specific microsurvey response
  </Card>
</CardGroup>
...
| `survey_id` | ID | The Chameleon ID of the [Microsurvey](/api/surveys#schema) |
...
| `profile` | object | An expandable [Profile](/api/profiles) model |
| `profile.company` | none | An expandable [Company](/api/companies) model embedded in the profile |
