...
| `properties`                | array&lt;Property&gt;      | The list of definitions of how to map CSV column headers to [Properties](/api/properties) on the model. [example ↓](/api/imports.md?id=examples-profiles-tag-all)                                                                                                                                                                               |
...
- Check out the [cURL Examples](/api/imports.md?id=examples-all-curl) below to see this in action.
...
| `409` | The number of Imports limit has been reached, see [limits ↑](/api/imports.md?id=limits) for details                    |
...
| `422` | The file is larger than the current limits [limits ↑](/api/imports.md?id=limits) allow                                 |
| `422` | The file has more columns than the current limits [limits ↑](/api/imports.md?id=limits) allow                          |
...
**See options for [Creating an Import](/api/imports.md?id=imports-create)**
...
Same endpoint as [show](/api/imports.md?id=imports-show), but adds a `.csv` on the end. The response body is the CSV data.
