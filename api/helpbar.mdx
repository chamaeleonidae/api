...
3. Add the top-level navigation within your product; First download this CSV [template](/api/helpbar#search-imports-template) or [example](/api/helpbar#search-imports-example) then [Import](/api/helpbar#searchimport-schema) it.
4. [Optional] Add specific content from your database by creating a [SearchItem](/api/helpbar#searchitem-schema) per database record you want to be searchable.
...
<CardGroup cols={2}>
  ...
  <Card title="Import Navigation" icon="map" href="#searchimport-schema">
...
`Search` is associated with `groups`: [SearchGroups](/api/helpbar#searchgroups-schema), and `label_themes`: [SearchLabelThemes](/api/helpbar#searchlabeltheme-schema)
...
| `oids`                        | none      | A set of pre-known IDs to directly add [SearchItem](/api/helpbar#searchitem-schema)s to the default [SearchGroup](/api/helpbar#searchgroups-schema)s |
...
| `created_at`                | timestamp | When this happened or when this was added to the Database                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `updated_at`                | timestamp | The last time any property was updated                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `url`                       | string    | The URL that this [SearchGroup](/api/helpbar#searchgroups-schema) uses to fetch Search content                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `icon`                      | object    | The `SearchIcon` info to display for all results of this [SearchGroup](/api/helpbar#searchgroups-schema)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `icon.image_url`            | none      | When using `kind="image"`, the url to an appropriate icon for this [SearchGroup](/api/helpbar#searchgroups-schema)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `icon.image_alt`            | none      | When using `kind="image"`, the alt text for the icon                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `url_options`               | object    | When configuring this [SearchGroup](/api/helpbar#searchgroups-schema) for an Search integration, Chameleon will fetch some information about the given URL                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
> `SearchItem`s are associated with `actions`: [SearchActions](/api/helpbar#searchaction-schema), and `title_labels` / `description_labels`: [SearchLabels](/api/helpbar#searchlabel-schema)
...
| `search_group_id`    | string    | The [SearchGroup](/api/helpbar#searchgroups-schema) that this `SearchItem` will display in.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `icon.image_url`     | sting     | When using `kind="image"`, the url to an appropriate icon for this [SearchGroup](/api/helpbar#searchgroups-schema)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `icon.image_alt`     | string    | When using `kind="image"`, the alt text for the icon                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `actions`            | array     | An array of the [`SearchAction`](/api/helpbar#searchaction-schema) that run when this `SearchItem` is clicked/selected in the HelpBar                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `title_labels`       | array     | An array of the [`SearchLabel`](/api/helpbar#searchlabel-schema) items displayed in the title of this `SearchItem`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `description_labels` | array     | An array of the [`SearchLabel`](/api/helpbar#searchlabel-schema) items displayed under the description of this `SearchItem`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `search_import_id` | optional | Fetch only the `SearchItem`s that were created (or updated most recently) by the given [SearchImport](/api/helpbar#searchimport-schema). |
...
Use any of the properties available in the [schema](/api/helpbar#searchitem-schema).
...
A search action is one item in a collection of actions attached to a [SearchItem](/api/helpbar#searchitem-schema)s. When
...
| `search_group_id`           | string    | The [SearchGroup](/api/helpbar#searchgroups-schema) that all of the resulting `SearchItem`s will display in.  (and/or this can be customized per row with "HelpBar Group ID" column) |
...
| `stats`                     | object    | The details of the data itself and of the last run of this [SearchImport](/api/helpbar#searchimport-schema).                                                      |
