...
In the HTTP Response for [Listing](/api/alert-groups#alert-groups-index) and [Showing](/api/alert-groups#alert-groups-show) Alert Groups,
...
| `kind` | string | The kind of matched Experiences for this Alert Group. [More info ↓](/api/alert-groups#alert-group-kinds): One of `all`, `tour`, `survey`, `tags`, or `campaigns` |
| `interval` | number | # of days that the alerting condition should wait before triggering a violation |
| `published_at` | timestamp | The time this was most recently published |
| `style` | string | The style of alert condition to evaluate. [More info ↓](/api/alert-groups#alert-group-styles): One of `unseen` or `uncompleted` |
