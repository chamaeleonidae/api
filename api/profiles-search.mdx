...
*If you want to know more about User Profiles, visit the [User Profiles section](/api/profiles).*
...
<CardGroup cols={3}>
  <Card title="Search Users" icon="magnifying-glass" href="#searching-users">
    Search for users by ID, UID, email, or custom properties
  </Card>
  <Card title="Count Users" icon="chart-bar" href="#counting-users">
    Get user counts based on properties and interactions
  </Card>
  <Card title="View Examples" icon="code" href="#examples">
    Explore search query examples and use cases
  </Card>
</CardGroup>
...
See the full [User Profile schema](/api/profiles#schema).
...
| param      | -        | description                                                  |
| ---------- | -------- | ------------------------------------------------------------ |
| `segment_id` | optional | The Chameleon Segment ID from the [List of Segments](/api/segments) |
| `filters`    | optional | The array of [Segmentation filter expressions](/concepts/filters) |
...
[See examples above](/api/profiles-search#examples)
...
**Use the same params / request body as [Searching Users](/api/profiles-search#profiles-index)**
