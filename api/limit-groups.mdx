...
<CardGroup cols={3}>
  <Card title="List Limit Groups" icon="list" href="#listing-limit-groups">
    Retrieve all rate limit groups with parameters
  </Card>
  <Card title="Get Limit Group" icon="eye" href="#showing-a-limit-group">
    Get a specific limit group by ID
  </Card>
  <Card title="List Related Experiences" icon="chain" href="#listing-related-experiences">
    Get all tours, surveys, and tags connected to this group
  </Card>
</CardGroup>
