...
| `company_id` | ID | The Chameleon ID of the [Company](/api/companies.md?id=schema) (only if associated) |
...
| `delivery_ids` | array&lt;ID&gt; | Ordered list of [Delivery](/api/deliveries.md?id=schema) model IDs |
| `company` | object | The expandable [Company](/api/companies.md?id=schema) (only if associated)  |
