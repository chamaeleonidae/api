...
##### Kinds of Alert Groups (`kind` property) {#alert-group-kinds}
...
##### Alerting conditions (`style` property) {#alert-group-styles}
| Kind | - | Description |
| --- | --- | --- |
...
## Listing Alert Groups {#alert-groups-index}
...
## Showing a Alert Group {#alert-groups-show}
