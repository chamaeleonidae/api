...
<ResponseField name="idempotency_key" type="string">
  A key that is used to enforce server-side "at most once delivery" for the given `profile_id`. [Learn more ↓](#idempotency)
</ResponseField>
...
<ParamField path="id" type="string" required>
  The Chameleon ID of the Delivery
</ParamField>

<ParamField path="*others" type="mixed">
  Any other params from [Create a Delivery](#deliveries-create)
</ParamField>
