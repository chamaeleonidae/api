...
## Data into Chameleon {#incoming-webhooks}
...
## Data out of Chameleon {#outgoing-webhooks}
...
| `alert.triggered`       | [example](webhooks/overview#example-alert-triggered)     | [Alert Group](apis/alert_groups), [Experiences](concepts/experiences)                                        | Sent when an Alert is triggered by a violation of the alerting conditions                                                                                                                                                                         |
| `helpbar.answer`        | [example](webhooks/overview#example-helpbar-answer)      | Action, [User Profile](apis/profiles)                                                                           | Sent when a Search query generates an AI Answer in HelpBar                                                                                                                                                                                        |
| `helpbar.search`        | [example](webhooks/overview#example-helpbar-search)      | Action, [User Profile](apis/profiles)                                                                           | Sent when a Search query displays its results in the HelpBar                                                                                                                                                                                      |
| `helpbar.item.action`   | [example](webhooks/overview#example-helpbar-item-action) | Action, [User Profile](apis/profiles)                                                                           | Sent when an item in the HelpBar is clicked/actioned                                                                                                                                                                                              |
| `helpbar.item.error`    | [example](webhooks/overview#example-helpbar-item-error)  | Action, [User Profile](apis/profiles)                                                                           | Sent when an action from an item in the HelpBar throws an error when running                                                                                                                                                                      |
| `tour.started`          | [example](webhooks/overview#example-tour-all)            | [Tour](apis/tours), [Step](apis/steps), [User Profile](apis/profiles)                                     | Sent when the Tour is started; includes the first Step in the payload                                                                                                                                                                             |
| `tour.completed`        | [example](webhooks/overview#example-tour-all)            | [Tour](apis/tours), [Step](apis/steps), [User Profile](apis/profiles)                                     | Sent when the Tour is completed; includes the Step the user completed                                                                                                                                                                             |
| `tour.exited`           | [example](webhooks/overview#example-tour-all)            | [Tour](apis/tours), [Step](apis/steps), [User Profile](apis/profiles)                                     | Sent when the Tour is exited; includes the Step the user exited                                                                                                                                                                                   |
| `tour.snoozed`          | [example](webhooks/overview#example-tour-snooze)         | Action, [Tour](apis/tours), [Step](apis/steps), [User Profile](apis/profiles)                             | Sent when the Tour is exited on Step configured to snooze (re-display the Step at a later time).                                                                                                                                                  |
...
| `survey.started`        | [example](webhooks/overview#example-survey-all)          | [Microsurvey](apis/surveys), [Step](apis/steps), [User Profile](apis/profiles)                            | Sent when the Microsurvey is started with the first Step                                                                                                                                                                                          |
| `survey.completed`      | [example](webhooks/overview#example-survey-all)          | [Microsurvey](apis/surveys), [Step](apis/steps), [User Profile](apis/profiles)                            | Sent when the Microsurvey is completed with the Step the user completed                                                                                                                                                                           |
| `survey.exited`         | [example](webhooks/overview#example-survey-all)          | [Microsurvey](apis/surveys), [Step](apis/steps), [User Profile](apis/profiles)                            | Sent when the Microsurvey is exited with the Step the user exited                                                                                                                                                                                 |
| `survey.snoozed`        | [example](webhooks/overview#example-survey-snooze)       | Action, [Microsurvey](apis/surveys), [Step](apis/steps), [User Profile](apis/profiles)                    | Sent when the Tour is exited on Step configured to snooze (re-display the Step at a later time).                                                                                                                                                  |
...
| `embed.started`         | [example](webhooks/overview#example-embed-all)           | [Embed](apis/tours), [Step](apis/steps), [User Profile](apis/profiles)                                    | Sent when the Embed is started; includes the first Step in the payload                                                                                                                                                                            |
| `embed.completed`       | [example](webhooks/overview#example-embed-all)           | [Embed](apis/tours), [Step](apis/steps), [User Profile](apis/profiles)                                    | Sent when the Embed is completed; includes the Step the user completed                                                                                                                                                                            |
| `embed.exited`          | [example](webhooks/overview#example-embed-all)           | [Embed](apis/tours), [Step](apis/steps), [User Profile](apis/profiles)                                    | Sent when the Embed is exited; includes the Step the user exited                                                                                                                                                                                  |
| `embed.snoozed`         | [example](webhooks/overview#example-embed-snooze)        | Action, [Embed](apis/tours), [Step](apis/steps), [User Profile](apis/profiles)                            | Sent when the Embed is exited on Step configured to snooze (re-display the Step at a later time).                                                                                                                                                 |
...
<Note>Looking for a different topic? We're excited to chat about your use case! [Contact us](https://app.chameleon.io/help)</Note>
...
<ParamField path="sent_at" type="timestamp">
The current server time when this webhook was sent (used in [verification](webhooks/overview#verification))
</ParamField>

<ParamField path="kind" type="enum">
The [topic identifier](webhooks/overview#topics)
</ParamField>

<ParamField path="data" type="object">
Contains the webhook payload data. This can be any models included by singular or plural name
</ParamField>
...
### Verifying the Webhook {#verification}
...
##### Example: `response.finished` {#example-response-finished}
...
##### Example: `helpbar.answer` {#example-helpbar-answer}
...
##### Example: `helpbar.search` {#example-helpbar-search}
...
##### Example: `helpbar.item.action` {#example-helpbar-item-action}
...
##### Example: `helpbar.item.error` {#example-helpbar-item-error}
...
##### Example: `tour.started`, `tour.completed`, `tour.exited` {#example-tour-all}
...
##### Example: `tour.snoozed` {#example-tour-snooze}

When a Tour is snoozed it is set to come back after a certain amount of time has passed (i.e. 1 day, 2 weeks, 2 hours etc.).

<Note>Look for `data.action` to be an object with the information on when this snooze ends, how many hours, and how many snoozes this totals.</Note>
...
##### Example: `tour.button.clicked` + `survey.button.clicked`  + `embed.button.clicked` {#example-tour-button-clicked}
...
##### Example: `embed.started`, `embed.completed`, `embed.exited` {#example-embed-all}
...
##### Example: `embed.snoozed` {#example-embed-snooze}
...
##### Example: `alert.triggered` {#example-alert-triggered}
...
<Note>[Experiences](concepts/experiences) are either `kind=tour` for a [Tour](apis/tours) or `kind=survey` for a [Microsurvey](apis/surveys)</Note>

<Note>For Tags and Environments see the `"tags"` and `"url_groups"` keys below and see [Experience](concepts/experiences) page.</Note>
...
##### Example: `survey.started`, `survey.completed`, `survey.exited` {#example-survey-all}
...
<Note>The Steps corresponding to a _Response_ Step have `preset=response`; The _Thank You_ Steps have  `preset=thank_you`</Note>
...
##### Example: `survey.snoozed` {#example-survey-snooze}
...
##### Example: `demo.started` {#example-demo-started}
...
<Note>For an anonymous user (e.g. on your marketing website) the `data.profile` will be `null` and `demo_run.anonymous_id` will be stable until local cache is cleared</Note>
...
##### Example: `demo.finished` {#example-demo-finished}

This webhook topic only differs from `demo.started` by the addition of the following keys in the `demo_run`.

1. In the `demo_run`, an `actions` array of [DemoAction](apis/demos#schema-demo-action)s
...
##### Example: `demo.reveal` {#example-demo-reveal}
...
##### Example: `demo.form.submitted` {#example-demo-form-submitted}
...
##### Example: `demo.email.added` {#example-demo-email-added}
