...
Currently, our Incoming Webhooks API supports the following two advanced use cases:
 ...
 - To send data from your Backend into Chameleon for targeting with [Segments](/api/segments).
...
When receiving a webhook from Chameleon you should:
 ...
 - Optional: Request any related data with the [other APIs](/api/overview)
...
| `response.finished`     | [example](/webhooks/overview#example-response-finished)   | [Response](/api/survey-responses), [Microsurvey](/api/surveys), [User Profile](/api/profiles)             | Sent when the Microsurvey is finished (all Steps completed; including text comment if configured)                                                                                                                                                 |
| `alert.triggered`       | [example](/webhooks/overview#example-alert-triggered)     | [Alert Group](/api/alert_groups), [Experiences](/concepts/experiences)                                        | Sent when an Alert is triggered by a violation of the alerting conditions                                                                                                                                                                         |
| `helpbar.answer`        | [example](/webhooks/overview#example-helpbar-answer)      | Action, [User Profile](/api/profiles)                                                                           | Sent when a Search query generates an AI Answer in HelpBar                                                                                                                                                                                        |
| `helpbar.search`        | [example](/webhooks/overview#example-helpbar-search)      | Action, [User Profile](/api/profiles)                                                                           | Sent when a Search query displays its results in the HelpBar                                                                                                                                                                                      |
| `helpbar.item.action`   | [example](/webhooks/overview#example-helpbar-item-action) | Action, [User Profile](/api/profiles)                                                                           | Sent when an item in the HelpBar is clicked/actioned                                                                                                                                                                                              |
| `helpbar.item.error`    | [example](/webhooks/overview#example-helpbar-item-error)  | Action, [User Profile](/api/profiles)                                                                           | Sent when an action from an item in the HelpBar throws an error when running                                                                                                                                                                      |
| `tour.started`          | [example](/webhooks/overview#example-tour-all)            | [Tour](/api/tours), [Step](/api/steps), [User Profile](/api/profiles)                                     | Sent when the Tour is started; includes the first Step in the payload                                                                                                                                                                             |
| `tour.completed`        | [example](/webhooks/overview#example-tour-all)            | [Tour](/api/tours), [Step](/api/steps), [User Profile](/api/profiles)                                     | Sent when the Tour is completed; includes the Step the user completed                                                                                                                                                                             |
| `tour.exited`           | [example](/webhooks/overview#example-tour-all)            | [Tour](/api/tours), [Step](/api/steps), [User Profile](/api/profiles)                                     | Sent when the Tour is exited; includes the Step the user exited                                                                                                                                                                                   |
| `tour.snoozed`          | [example](/webhooks/overview#example-tour-snooze)         | Action, [Tour](/api/tours), [Step](/api/steps), [User Profile](/api/profiles)                             | Sent when the Tour is exited on Step configured to snooze (re-display the Step at a later time).                                                                                                                                                  |
| `tour.button.clicked`   | [example](/webhooks/overview#example-tour-button-clicked) | [Tour](/api/tours), [Step](/api/steps), [Button](/api/buttons), [User Profile](/api/profiles)          | Sent when the Tour is exited with the Step the user exited                                                                                                                                                                                        |
| `survey.started`        | [example](/webhooks/overview#example-survey-all)          | [Microsurvey](/api/surveys), [Step](/api/steps), [User Profile](/api/profiles)                            | Sent when the Microsurvey is started with the first Step                                                                                                                                                                                          |
| `survey.completed`      | [example](/webhooks/overview#example-survey-all)          | [Microsurvey](/api/surveys), [Step](/api/steps), [User Profile](/api/profiles)                            | Sent when the Microsurvey is completed with the Step the user completed                                                                                                                                                                           |
| `survey.exited`         | [example](/webhooks/overview#example-survey-all)          | [Microsurvey](/api/surveys), [Step](/api/steps), [User Profile](/api/profiles)                            | Sent when the Microsurvey is exited with the Step the user exited                                                                                                                                                                                 |
| `survey.snoozed`        | [example](/webhooks/overview#example-survey-snooze)       | Action, [Microsurvey](/api/surveys), [Step](/api/steps), [User Profile](/api/profiles)                    | Sent when the Tour is exited on Step configured to snooze (re-display the Step at a later time).                                                                                                                                                  |
| `survey.button.clicked` | [example](/webhooks/overview#example-tour-button-clicked) | [Microsurvey](/api/surveys), [Step](/api/steps), [Button](/api/buttons), [User Profile](/api/profiles) | Sent when the Tour is exited with the Step the user exited                                                                                                                                                                                        |
| `embed.started`         | [example](/webhooks/overview#example-embed-all)           | [Embed](/api/tours), [Step](/api/steps), [User Profile](/api/profiles)                                    | Sent when the Embed is started; includes the first Step in the payload                                                                                                                                                                            |
| `embed.completed`       | [example](/webhooks/overview#example-embed-all)           | [Embed](/api/tours), [Step](/api/steps), [User Profile](/api/profiles)                                    | Sent when the Embed is completed; includes the Step the user completed                                                                                                                                                                            |
| `embed.exited`          | [example](/webhooks/overview#example-embed-all)           | [Embed](/api/tours), [Step](/api/steps), [User Profile](/api/profiles)                                    | Sent when the Embed is exited; includes the Step the user exited                                                                                                                                                                                  |
| `embed.snoozed`         | [example](/webhooks/overview#example-embed-snooze)        | Action, [Embed](/api/tours), [Step](/api/steps), [User Profile](/api/profiles)                            | Sent when the Embed is exited on Step configured to snooze (re-display the Step at a later time).                                                                                                                                                 |
| `embed.button.clicked`  | [example](/webhooks/overview#example-tour-button-clicked) | [Embed](/api/tours), [Step](/api/steps), [Button](/api/buttons), [User Profile](/api/profiles)         | Sent when the Embed is exited with the Step the user exited                                                                                                                                                                                       |
| `demo.started`          | [example](/webhooks/overview#example-demo-started)        | [Demo](/api/demos), [DemoRun](/api/demos#schema-demo-run), [User Profile](/api/profiles)               | Sent when the Demo is started                                                                                                                                                                                                                     |
| `demo.reveal`           | [example](/webhooks/overview#example-demo-reveal)         | [Demo](/api/demos), [DemoRun](/api/demos#schema-demo-run), [User Profile](/api/profiles)               | Sent after the Demo is started _and_ [Clearbit reveal](https://app.chameleon.io/integrations/clearbit) is enabled _and_ a match is found. The `demo_run` will have `reveal_domain` and `reveal_name` keys for the Company domain and Company name |
| `demo.finished`         | [example](/webhooks/overview#example-demo-finished)       | [Demo](/api/demos), [DemoRun](/api/demos#schema-demo-run), [User Profile](/api/profiles)               | Sent when the Demo is finished; Either the last step is reached **OR** when approximately 30 minutes has passed and the user likely bounced. The `demo_run` will have `finished_kind` of either `"last_step"` or `"timeout_30m"`.                 |
| `demo.form.submitted`   | [example](/webhooks/overview#example-demo-form-submitted) | [Demo](/api/demos), [DemoRun](/api/demos#schema-demo-run), [User Profile](/api/profiles)               | Sent when a Demo form is submitted. The `action` will have the `submission` as a [DemoSubmission](/api/demos#schema-demo-submission) object. The final demo.finished webhook will contain all of the `actions` and `submissions`            |
...
**Have an example from your production app to add? Submit a [PR to this file](https://github.com/chamaeleonidae/api/blob/master/docs/webhooks/overview) and we'll give you $25 Amazon credit via our Docs Bounty program!**
...
#### Example: `response.finished`-response-finished
...
#### Example: `helpbar.answer`-helpbar-answer
...
#### Example: `helpbar.search`-helpbar-search
...
#### Example: `helpbar.item.action`-helpbar-item-action
...
#### Example: `helpbar.item.error`-helpbar-item-error
...
#### Example: `tour.started`, `tour.completed`, `tour.exited`-tour-all
...
#### Example: `tour.snoozed`-tour-snooze
...
#### Example: `tour.button.clicked` + `survey.button.clicked`  + `embed.button.clicked`-tour-button-clicked
...
#### Example: `embed.started`, `embed.completed`, `embed.exited`-embed-all
...
#### Example: `embed.snoozed`-embed-snooze
...
#### Example: `alert.triggered`-alert-triggered
...
> [Experiences](/concepts/experiences) are either `kind=tour` for a [Tour](/api/tours) or `kind=survey` for a [Microsurvey](/api/surveys)
...
#### Example: `survey.started`, `survey.completed`, `survey.exited`-survey-all
...
no longer interact with it. A [Microsurvey Response](/api/survey-responses) is generated when the Survey Step + associated
...
#### Example: `survey.snoozed`-survey-snooze
...
#### Example: `demo.started`-demo-started

Right when the Demo is first started in this session. Chameleon calls this a Demo "run".

Demos can also [sync Contact data](/api/demos#demos-in-the-crm) into the CRM
...
#### Example: `demo.finished`-demo-finished

This webhook topic only differs from `demo.started` by the addition of the following keys in the `demo_run`.

1. In the `demo_run`, an `actions` array of [DemoAction](/api/demos#schema-demo-action)s
2. In the `demo_run`, a `submissions` array of [DemoSubmission](/api/demos#schema-demo-submission)s with a `data` key of [DemoSubmissionData](/api/demos#schema-demo-submission-data)
...
#### Example: `demo.reveal`-demo-reveal
...
#### Example: `demo.form.submitted`-demo-form-submitted
...
`action.submission` is a [DemoSubmission](/api/demos#schema-demo-submission)s with a `data` key of [DemoSubmissionData](/api/demos#schema-demo-submission-data) and
each data item has a `field` as [DemoFormField](/api/demos#schema-demo-form-field) and `value`.
...
#### Example: `demo.email.added`-demo-email-added
...
1. **Demos taken => Submits interest form**
   ...
   3. Chameleon will then update all the previous [DemoRun](/api/demos#schema-demo-run)s from [1i] (e.g. those connected with the `anonymous_id`)
   4. Chameleon sends one `demo.email.added` webhook per updated [DemoRun](/api/demos#schema-demo-run)
...
2. **Demos taken => Product signup**
   ...
   3. Chameleon will then update all the previous [DemoRun](/api/demos#schema-demo-run)s from [2i] (e.g. those connected with the `anonymous_id`)
   4. Chameleon sends one `demo.email.added` webhook per updated [DemoRun](/api/demos#schema-demo-run)
