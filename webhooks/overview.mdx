...
##### Example: `tour.started`, `tour.completed`, `tour.exited`
...
##### Example: `tour.button.clicked` + `survey.button.clicked`  + `embed.button.clicked`
...
##### Example: `embed.started`, `embed.completed`, `embed.exited`
...
##### Example: `survey.started`, `survey.completed`, `survey.exited`
