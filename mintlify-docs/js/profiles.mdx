---
title: "Send user properties via JS API"
description: "Sync user and company data to Chameleon for targeting users with Tours, personalizing content, and better URL matching."
---

- [Targeting users](/apis/segments) with Tours based on who they are.
- [Personalizing content](/concepts/personalizing) within Experiences (merge tags in content).
...
## Clearing and disabling the Chameleon install (`chmln.clear()`)
