---
title: "Product Demos"
description: "A Product Demo is recorded by a Chameleon admin and shown to your end-users to demonstrate features and explain workflows."
---
...
_For simplicity, and unless otherwise specified, adding User ID for an identified user, changes to [consent](/js/demos#cookie-consent) of `granted`._
