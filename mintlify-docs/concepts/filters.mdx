...
description: "A filter expression is a codified query used for user segmentation, containing a combination of keys and values that instruct the query builder."
---
