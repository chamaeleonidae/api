---
title: "Errors"
description: "Reference this page for HTTP status codes and error messages returned by the Chameleon API."
---

The Chameleon API is robust with 99.99% uptime and extensive monitoring. In case you are facing any error, you can check our [Status Page](https://status.chameleon.io).
...
See also [Rate limiting](/concepts/rate-limiting)
...
Unexpected maintenance, API downtime or the inability to shed enough load with [Rate limiting](/concepts/rate-limiting)
