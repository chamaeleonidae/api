---
title: "Errors"
description: "The Chameleon API is robust with 99.99% uptime and extensive monitoring. In case you are facing any error, you can check our Status Page at status.chameleon.io"
---
