...
| `url_group_id`  | ID        | The Environment ([Url Group](/apis/urls#url-groups)) this Url is a part of. `null` to be part of all Environments.                         |
...
```http title="POST"
https://api.chameleon.io/v3/edit/urls
```
...
| `unlisted`     | optional | [deprecated; replaced by `archived_at`] Whether or not the Url is displayed on the [Domains page](https://app.chameleon.io/settings/domains) in the dashboard |
| `archived_at`  | optional | To archive set to a timestamp, to unarchive set to `null`                                                                                                         |
| `url_group_id` | optional | The Environment ([Url Group](/apis/urls#url-groups)) to assign this Url to                                                                                                                 |
...
<a id="urls-bulk-update"></a>
## Bulk a Url
#### HTTP Request

```http title="POST"
https://api.chameleon.io/v3/edit/urls/batch
```
...
| `archived_at`  | optional | To archive set to a timestamp, to unarchive set to `null`                         |
| `url_group_id` | optional | The Environment ([Url Group](/apis/urls#url-groups)) to assign these Urls to |
...
```http title="GET"
https://api.chameleon.io/v3/edit/urls/:id
```
...
<a id="url-groups-create"></a>
## Create a Url Group
#### HTTP Request

```http title="POST"
https://api.chameleon.io/v3/edit/url_groups
```
...
<a id="url-groups-show"></a>
## Retrieve a Url Group
#### HTTP Request

```http title="GET"
https://api.chameleon.io/v3/edit/url_groups/:id
```

| param  | -        | description                                                                            |
|--------| -------- |----------------------------------------------------------------------------------------|
| `id`   | required | The Chameleon ID of the Environment ([Url Group](/apis/urls#url-groups)) to show  |
