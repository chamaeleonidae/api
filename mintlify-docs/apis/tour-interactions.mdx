...
description: "A Tour Interaction is a state object which contains the current view of a Tour for a specific User Profile."
---
...
| `tour_id` | ID | The Chameleon ID of the [Tour](/apis/tours) |
...
<a id="tour-interactions-index"></a>
