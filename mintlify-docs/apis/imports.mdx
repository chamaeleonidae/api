...
title: "Data Imports"
description: >
  Imports are used to add data to Chameleon via CSV. Each row should correspond with one record in the Chameleon database. You may import data into User Profiles or Companies with the model_kind property.
---
...
<a id="examples-profiles-tag-all"></a>
...
<a id="examples-companies-tag-all"></a>
...
<a id="examples-profiles-update-all"></a>
...
<a id="examples-profiles-delete-by-id"></a>
...
<a id="examples-profiles-delete-by-email"></a>
...
```http title="GET"
https://api.chameleon.io/v3/edit/imports/:id
```
...
```http title="GET"
https://api.chameleon.io/v3/edit/imports/:id.csv
```
