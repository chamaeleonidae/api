---
title: "Data Imports"
description: "Imports are used to add data to Chameleon via CSV. Each row should correspond with one record in the Chameleon database (called a model below). You may import data into a User Profile or a Company with the model_kind property."
---
