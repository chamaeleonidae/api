---
title: "Webhooks"
description: "This doc is all about how to manage your webhook subscriptions via API."
---

> See the [Webhooks page](/webhooks/overview) for information about the Webhooks that Chameleon sends to configured endpoints
...
| `topics`         | required | A comma-separated list OR Array of topics to send webhooks for. Any/all of the [Webhook topics](/webhooks/overview#topics) |
...
```http title="DELETE"
https://api.chameleon.io/v3/edit/webhooks/:id
```
