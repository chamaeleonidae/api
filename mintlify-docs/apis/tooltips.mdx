---
title: "Tooltips"
description: "A Tooltip is a single step which can be shown when your end-users click or hover on either:"
---
...
```http title="GET"
https://api.chameleon.io/v3/edit/tooltips
```
...
```http title="PATCH"
https://api.chameleon.io/v3/edit/tooltips/:id
```
