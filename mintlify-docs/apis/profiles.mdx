...
```http title="DELETE"
https://api.chameleon.io/v3/edit/profiles/:id
```

or

```http title="DELETE"
https://api.chameleon.io/v3/edit/profiles?uid=:uid
```
...
```http title="DELETE"
https://api.chameleon.io/v3/edit/profiles/:id/forget
```

or

```http title="DELETE"
https://api.chameleon.io/v3/edit/profiles/forget?uid=:uid
```
