...
4. **Check the topics** — Verify the webhook is registered for the topics you expect. See [webhook topics](/webhooks/outgoing#topics).
...
See also:
- [Outgoing Webhooks](/webhooks/outgoing) — full reference for topics, schemas, and payload examples
