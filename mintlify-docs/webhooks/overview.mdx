...
| `helpbar.answer`        | [example](/webhooks/overview#example-helpbar-answer)      | [Action](/webhooks/overview#schema-helpbar-answer), [User Profile](/apis/profiles)                                                          | Sent when a Search query generates an AI Answer in HelpBar                                                                                                                                                                                        |
| `helpbar.search`        | [example](/webhooks/overview#example-helpbar-search)      | [Action](/webhooks/overview#schema-helpbar-search), [User Profile](/apis/profiles)                                                          | Sent when a Search query displays its results in the HelpBar                                                                                                                                                                                      |
| `helpbar.item.action`   | [example](/webhooks/overview#example-helpbar-item-action) | [Action](/webhooks/overview#schema-helpbar-item-action), [User Profile](/apis/profiles)                                                     | Sent when an item in the HelpBar is clicked/actioned                                                                                                                                                                                              |
| `helpbar.item.error`    | [example](/webhooks/overview#example-helpbar-item-error)  | [Action](/webhooks/overview#schema-helpbar-item-error), [User Profile](/apis/profiles)                                                      | Sent when an action from an item in the HelpBar throws an error when running                                                                                                                                                                      |
